...
class Trajformer(nn.Module):
    def __init__(self, num_classes, num_layers, dim_hidden, freq, num_kernels, input_dim_st, input_dim_text, alpha, scaler, num_heads, dropout, attn_threhold, return_attention):
        super().__init__()
        self.num_heads = num_heads
